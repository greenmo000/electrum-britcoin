...
;Variables
  ...
  !define PRODUCT_NAME "ElectrumBritcoin"
  !define PRODUCT_WEB_SITE "https://github.com/greenmo000/electrum-britcoin"
  !define PRODUCT_PUBLISHER "Britcoin Foundation"
...
Section
  ...
  ;Links britcoin: URI's to Electrum
  WriteRegStr HKCU "Software\Classes\britcoin" "" "URL:britcoin Protocol"
  WriteRegStr HKCU "Software\Classes\britcoin" "URL Protocol" ""
  WriteRegStr HKCU "Software\Classes\britcoin" "DefaultIcon" "$\"$INSTDIR\electrum.ico, 0$\""
  WriteRegStr HKCU "Software\Classes\britcoin\shell\open\command" "" "$\"$INSTDIR\electrum.exe$\" $\"%1$\""
...
Section "Uninstall"
  ...
  DeleteRegKey HKCU "Software\Classes\britcoin"
